...
- **M4** reranker best-chunk passage. ⏳ DEFERRED (documented). Targets the residual ~15% reranker-false-positive noise; needs a body-aware re-chunk (store ordinals are envelope-inclusive, rerank passages body-only).
